...
const GUIDE_TOPICS = {
  start: {
    title: "Start here",
    body: `
      <p class="guide-lead">Choose the workspace that matches the question you want to answer. Every completed run keeps its seed so an unusual result can be reproduced.</p>
